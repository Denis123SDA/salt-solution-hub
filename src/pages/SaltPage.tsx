            ...
            <form onSubmit={handlePriceSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select value={form.product} onChange={e => setForm(p => ({ ...p, product: e.target.value }))} className="w-full px-4 py-3 rounded-md border border-input bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring">
                  ...
                  <option value="Кормовая соль Аралтуз в брикетах">Кормовая соль Аралтуз в брикетах</option>
            ...
            {[
              {
                ...
                icon: Package,
                name: "Кормовая соль Аралтуз в брикетах",
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-6 border border-border rounded-lg bg-card">
                ...
                <div>
                  ...
                  <p className="text-foreground font-semibold">Наличными или по счёту</p>
                  <p className="text-muted-foreground text-sm mt-1">Оплата через терминал не предусмотрена</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">Оплата по терминалу не предусмотрена</p>
                </div>
              </div>
            </div>
