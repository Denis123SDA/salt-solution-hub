...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Политика конфиденциальности | Севуч Плюс";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Политика конфиденциальности компании Севуч Плюс. Порядок обработки и защиты персональных данных пользователей сайта.");
    return () => {
    ...
    <div className="min-h-screen bg-background py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-sm text-foreground/90 space-y-4">
          ...
          <p>Оставляя заявку на сайте, вы даёте согласие на обработку ваших персональных данных в соответствии с настоящей Политикой и Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных».</p>
